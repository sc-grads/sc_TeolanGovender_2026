...
add constraint PK_tblEmployee PRIMARY KEY (EmpNumber)

--While EmpNumber is a PK, you cannot add this twice
insert into tblEmployee(EmpNumber, EmpFirstName, EmpMiddleName, EmpLastName, 
EmpGovernmentID, DateOfBirth, Department) 
values (2004, 'FirstName', 'MiddleName', 'LastName', 'AB12345FI', '2014-01-01', 'Accounts')

delete from tblEmployee
where EmpNumber = 2004

alter table tblEmployee
drop constraint PK_tblEmployee

create table tblEmployee2
(EmpNumber int CONSTRAINT PK_tblEmployee2 PRIMARY KEY IDENTITY(1,1),
...
insert into tblEmployee2(EmpNumber, EmpName)
...
(EmpNumber int CONSTRAINT PK_tblEmployee3 PRIMARY KEY IDENTITY(1,1),
EmpName nvarchar(20))
